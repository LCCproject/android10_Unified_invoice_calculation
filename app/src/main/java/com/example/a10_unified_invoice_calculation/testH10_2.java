...
public class testH10_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_h102);
    ...
    public void back(View view) {
        ...
        intent.setClass(testH10_2.this, testH10.class);
        testH10_2.this.finish();
    }

    public void result(View view) {
        Intent intent = new Intent();
        intent.setClass(testH10_2.this,testH10_3.class);
        for(int j=2;j<5;j++) {
